   ...
   function showSelectedDinner(){
    ...
    dinners = ['Pizza','Pasta and Meatballs', 'Chicken Cutlets', 'Pork tenderloin', 'Tacos', 'Baked Chicken','Chicken Enchiladas','Hotdogs','Stirfry','Breakfast for dinner','Italian sausage','Steak','Barbeque pulled pork','Quesidillas','Speghetti Squash','Macoroni and cheese'];
   ...
   function showLinks(){
    ...
    function clearLinks(){
        var button = document.getElementById('dinner--button').remove();
    }